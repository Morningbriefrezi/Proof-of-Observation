...
export const MISSIONS: Mission[] = [
  ...
  },
  {
    ...
    stars: 10,
    type: 'naked_eye',
    desc: 'Try the full observation flow. Capture a photo, verify sky conditions, and mint your first NFT.',
    hint: 'Just point your camera anywhere — at the sky, a light, or straight up. This mission tests the whole pipeline.',
    target: 'Test Observation',
    repeatable: true,
  },
