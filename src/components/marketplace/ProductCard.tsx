...
export default function ProductCard({ product, dealerName }: Props) {
  ...
  return (
    <div
      className="relative flex flex-col rounded-lg p-[10px] transition-colors"
      style={{
    ...
    >
      ...
      <div
        className="flex justify-between items-center pt-[6px] mb-[8px]"
      ...
      <div className="flex gap-[4px]">
        <Link
          ...
          className="flex-1 text-center px-[6px] py-[6px] rounded-md text-[9px] tracking-[0.14em] uppercase font-semibold transition-colors"
          style={{
            background: 'rgba(255, 209, 102, 0.08)',
            border: '0.5px solid rgba(255, 209, 102, 0.40)',
        ...
        <Link
          ...
          style={{
            ...
            border: '0.5px solid rgba(94, 234, 212, 0.40)',
            color: 'var(--seafoam)',
          }}
