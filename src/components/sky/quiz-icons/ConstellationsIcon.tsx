    ...
    <svg width={size} height={size} viewBox="0 0 56 56" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <radialGradient id="ci-star" cx="0.5" cy="0.5" r="0.5">
          ...
          <stop offset="0.3" stopColor="#B8D4FF" />
      ...
      <circle cx="8" cy="44" r="0.5" fill="#B8D4FF" opacity="0.5" />
      <circle cx="48" cy="42" r="0.5" fill="#B8D4FF" opacity="0.5" />
